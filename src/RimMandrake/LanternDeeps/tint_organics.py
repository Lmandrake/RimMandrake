...
Textures/RM_LanternDeeps/Things/Plant by +70 deg; warm hues (BrellikBulb's amber) and greys
...
Crystals/, Chunks/, Item/, Natural/ or Terrains/.
    ...
    python3 src/RimMandrake/LanternDeeps/tint_organics.py            # dry run: lists files
    python3 src/RimMandrake/LanternDeeps/tint_organics.py --apply    # writes in place
    python3 src/RimMandrake/LanternDeeps/tint_organics.py --apply --sheet Transient/deeps_tint/plants_before_after.png
"""
