...
namespace RimMandrake.LanternDeeps
{
	...
	// counterpart to RM_LanternDeepEmergence's natural-mouth scatter
	...
	public class GenStep_ScatterMineshaftPortal : GenStep_ScatterGroup
	{
		...
		private static ThingDef MineshaftDef =>
			mineshaftDefCached ?? (mineshaftDefCached = DefDatabase<ThingDef>.GetNamedSilentFail("RM_LanternDeepMineshaft"));
