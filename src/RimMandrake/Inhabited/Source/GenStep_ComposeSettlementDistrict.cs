...
namespace RimMandrake.Inhabited
{
    ...
    public class GenStep_ComposeSettlementDistrict : GenStep
    {
        ...
        /// RUT_Jawa_Junkers, tech Neolithic (the depot floor is explicitly
        ...
        /// AshkarrInhabited (Gorga the Immense's Palace / RUT_Jawa_HuttCartel,
        /// The Cracking Yard / RUT_Jawa_FreeDroidEnclaves, Deepwater Hold /
        /// RUT_Jawa_DeepwaterCompact) whose district LABELS are unique across the
        ...
        private static readonly Dictionary<string, string> TemplateFiles =
            ...
            {
                // The Claim Jump (RUT_Jawa_Junkers, Neolithic)
                ...
                // Gorga the Immense's Palace (RUT_Jawa_HuttCartel, Industrial)
                ...
                // The Cracking Yard (RUT_Jawa_FreeDroidEnclaves, Spacer)
                ...
                // Deepwater Hold (RUT_Jawa_DeepwaterCompact, Industrial)
