...
public class DamageWorker_KotORPlasmaGrenade : DamageWorker_Flame
{
    public override void ExplosionAffectCell(Explosion explosion, IntVec3 c, List<Thing> damagedThings, List<Thing> ignoredThings, bool canThrowMotes)
    {
        ...
        if (RSW_ArmourySettings.plasmaGrenadeFires && def == DamageDefOf_guy762.guy762_GrenadeDamage_plasma
            && Rand.Chance(FireUtility.ChanceToStartFireIn(c, explosion.Map)))
        {
