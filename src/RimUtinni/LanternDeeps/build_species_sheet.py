...
One row per plant/animal that actually spawns in RUT_LanternDeeps, showing the
...
LD_TEX = REPO_ROOT / "src/RimUtinni/LanternDeeps/Textures/RUT_LanternDeeps/Things"
...
# ---------------------------------------------------------------------------
# FLORA — RUT_LanternDeeps.wildPlants, MEASURED from
# src/RimUtinni/LanternDeeps/Defs/Biomes/RUT_LanternDeeps.xml (2026-09-18).
...
FLORA = [
    ("RUT_DeepMycelium", "mycelium", 5.0,
     ...
     "RUT_LanternDeeps/Things/Plant/Mycelium",
     LD_TEX / "Plant/Mycelium/A.png", "owned", ""),
    ("RUT_ZivvitTaper", "zivvit taper", 1.0,
     ...
     "RUT_LanternDeeps/Things/Plant/ZivvitTaper",
     LD_TEX / "Plant/ZivvitTaper/A.png", "owned", ""),
    ("RUT_QuorrFern", "quorr fern", 0.5,
     ...
     "RUT_LanternDeeps/Things/Plant/QuorrFern",
     LD_TEX / "Plant/QuorrFern/A.png", "owned", ""),
    ("RUT_ThrakkCap", "thrakk cap", 0.5,
    ...
    ("RUT_Lanternstone_Sowable", "fast growing lanternstone", 0.1,
     ...
     "RUT_LanternDeeps/Things/Crystals/LanternstoneMedium (shared with the Medium rock formation Building)",
    ...
    ("RUT_VellokReed", "vellok reed", 0.05,
     ...
     "RUT_LanternDeeps/Things/Plant/VellokReed",
     LD_TEX / "Plant/VellokReed/A.png", "owned", ""),
    ("RUT_TwitchingPuffer", "twitching puffer", 0.02,
     ...
     "RUT_LanternDeeps/Things/Plant/TwitchingPuffer/PufferGrown",
...
def main():
    ...
    cfg = {
        ...
        "briefHtml": (
            ...
            "(<code>RUT_LanternDeeps</code>'s own <code>&lt;wildPlants&gt;</code>/"
            ...
            "spawn table (a real edit to RUT_LanternDeeps.xml); <b>Regen</b> leaves the "
