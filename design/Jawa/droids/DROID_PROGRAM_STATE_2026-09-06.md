...
| `DROIDWORKS_DLL_COMPILE_1` · `DROIDWORKS_PHASE0_XML_1` · `DROIDWORKS_ION_GUARD_1` · `DROIDWORKS_DEF_GENERATOR_1` · `DROIDWORKS_PILOT_GONK_1` · `DROIDWORKS_CHARGING_TRIO_1` · `DROIDWORKS_BOLT_CORE_1` · `DROIDWORKS_WIPE_AND_SPIKE_1` · `DROIDWORKS_FAMILY_LAYER_1` · `DROIDWORKS_FLESHTYPE_NEEDS_GAP_1` · `DROIDWORKS_ISFLESH_RELATIONS_CRASH_1` · `DROIDWORKS_POWEREDDOWN_NOT_WIRED_1` · `DROIDWORKS_CHARGER_STATE_MACHINE_SWEEP_1` · `DROIDWORKS_GENERATOR_NAMING_DRIFT_1` | all **done** | Phase 0 + most of Phase 1 verbs, built 2026-08-30 → 09-05 |
