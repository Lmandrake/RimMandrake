...
| **Alchemical / relic** | Sith remnant, Rakatan ruin, Anomaly | `tuk'ata`-style names, apostrophes allowed | Colossal apexes with no ecological story. The archotech line sits here rather than beside it: archotech **is** Rakatan tech (canon `archotech_is_rakatan`), so an archotech war-form is a relic of the same ruin — cf. the Infinite, §the bestiary's Rakatan war-form. |
