...
> **AMENDED 2026-09-24, same sitting: all 8 open rulings landed** (see the
> fauna doc's RULED section for provenance and full texts). Applied here: the
> dorvel's growth caveat (§2 row 2, typed ruling), the pallick's lie ruled
> allowed (§4 row 10, card), the naming voice ruled kept-both (card).
