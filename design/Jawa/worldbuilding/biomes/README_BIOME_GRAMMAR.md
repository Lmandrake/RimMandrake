...
| **next** | **the Scald** — the last sheet: the third sea has none (`terminator_sea.md` uses it only as a foil) | 🔵 ocean/lake-bottom biomes DEFERRED to the mods that need them (owner, 2026-09-07); the land campaign is otherwise COMPLETE |
