...
| **next** | `ZBiome_Grasslands` 226 = **the Pyrelands** (ruled 2026-08-15, fire canon in `hydrology_and_fire_ecology.md`) — in the loop 2026-09-07 | 🔵 then the volcanic family (`AB_PyroclasticConflagration` 31 + `LavaField` 8 + `Volcano` 5, one sheet) · the Scald (no sheet — reconciliation note) · ocean/lake-bottom biomes DEFERRED to the mods that need them (owner, 2026-09-07) |
