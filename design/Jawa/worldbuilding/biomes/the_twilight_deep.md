# The Twilight Deep — definition sheet
...
**the last ordinary sea** — and its image: **golden light-wells in dim green
water, kelp towers, crowds — and lamplit dwellings on the bottom, where the
Deepwater Compact has been living all along.**_
...
ordinary carbon-and-water biochemistry "runs here and nowhere else." Under
the roof, it runs riot.
...
Terminator sea-bottom × **the roof**: the one basin on Ash'karr where
mildness, shelter, and light-in-measured-doses coexist. The last ordinary
marine ecosystem in the world, in one lidded bowl, at permanent sunset.
...
- ⭐ **The underwater rivers** (owner): denser water sinking along the
  ...
  carry nutrients, they carve the bottom's geography, swimming into one
...
## 4. What lives here — rich and varied as the land, by ruling
...
- **The shoals** — schools, finally and only here: silver crowds in the
  ...
  the physics to justify it).
- **The river-fauna** — bank-dwellers of the mud channels: burrowers,
  sifters, and the fat slow things that ride the invisible current.
...
- **One true predator** — fast and almost nostalgically ordinary, hunting
  the shoals in the dark between columns.
- **The abundance around them** — the roster pass populates generously
  here, uniquely: this sheet is the one place "do we already have one?"
  may answer *yes, and another.*

## 5. Always true

- The roof holds, the skylights drift, the rivers run dry-looking and
  full.
- The crowds are real and belong; the surface above stays solitary and
  must never learn otherwise from below.
- The gardener tends; the Compact tends beside it.
- The banks are the wealth; the columns are the light; the dark between
  is the predator's.
- Everything ordinary that survives anywhere survives only here — and
  knows it, and so do its keepers.
...
- **The only ordinary fishing on the planet** — nets in the light columns;
  a fishing economy that works like fishing, nowhere else true.
- **Kelp agriculture** — tended forest plots: the sea-farm the dayside can
  never have.
- **Skylight rights** — bright columns as claimable, contestable,
  *expiring* real estate; the Compact meters them and the gardener decides
  which exist.
- **River-bank harvest** — the mud channels' banks: the richest gathering
  ground, nutrient-fed forever.
- **The Compact's hospitality** — dock-rights, air, lamplight, and charts,
  for those they permit below (§8).

## 8. Inhabited objects — what they've been doing all this time

⭐ **The Twilight Deep is POPULATED** (owner): **the Deepwater Compact is
here richly — their inhabited dwellings stand on the bottom.** The
water-monopolists the surface knows are, below the roof, revealed as
**keepers of the last ordinary sea**: lamplit bottom-dwellings on the river
banks and skylight margins, kelp plots in tended rows, instruments moored to
the ceiling, gardener-ways respectfully skirted. The surface world knows
them as sellers of water; only those who dive learn what the water bought —
an ark, kept. (Their scholars read the old tongue — Scarlands canon — and
what their soundings and ledgers know about all three seas' fates is theirs
to trade or keep.)

- **v1**: the dwellings, plots, moorings and lamplight EXIST and are
  inhabited — the reveal is real on any dive.
- 🔵 **v2 (owner's plan of record)**: **an entire Compact settlement** in
  the Deep — a functioning underwater town. Kept in full as the v2 plan;
...
**"Golden wells in green dusk, lamplight on the riverbanks below."**
...
- **Sound:** the rich water-noise the whole planet lacks — click, chirr,
  ...
  lamplit domestic sounds carrying from the banks. After every other
  biome: the sound of company.

---

## Owed

- **Implementation deferred by ruling** to the diving mods; the kit when
  needed: roof/ceiling rendering, skylight drift, bottom-river currents
  (sink hazard, bank riches), the fishing/kelp economies, Compact
  dwelling gen, the gardener set-piece.
...
- **Cross-flow ledger**: `the_grey_deep.md` (the sister underworld — the
  statuary against the ark); `terminator_sea.md` (surface law, scoped);
  the Miasma (the Grey's crèche; whether the Twilight's life needs one is
  answered: it has a whole sea); `LIQUID_TYPES_MOD_1` (density-current
  water as a grade).
