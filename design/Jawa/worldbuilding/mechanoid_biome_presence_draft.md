...
| The Lantern Deeps — mechanoid production facility | site/dungeon | **RULED-adjacent** | Autonomous-trickle restocker of the Forgotten Sentinels (ruled 2026-09-11); a site with a restore-or-not choice, not a mapgen scatter. Rides `MECHANOID_ORIGIN_CANON_1`. |
