...
| The Lantern Deeps — mechanoid production facility | site/dungeon | **RULED-adjacent** | Autonomous trickle feeding the SECRET CACHES and Cathedral vaults/supply lines only — surface Sentinels are lost, self-repairing, slowly devolving units, never replenished (legends sitting 2026-09-11, `mindstone_arc_legends.md`); a site with a restore-or-not choice, not a mapgen scatter. Rides `MECHANOID_ORIGIN_CANON_1`. |
