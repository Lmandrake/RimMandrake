...
3. The three wet biomes contain, by roster, exactly one Burst plant (`Plant_HubbaGourd_Wild` in the Greentide) and no TINDER or RUPTURE plant — so ruling 6 ("never detonate") holds by plant identity everywhere except that one row. See hard calls.
