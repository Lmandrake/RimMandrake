...
**defName**: `RSW_Porg` (vendored in SWBestiary)
...
them much lighter than they look. Habitat: coastal cliffs, islands, and open
...
each other: porgs are **round, egg/teardrop-shaped birds** with a
disproportionately large head-to-body ratio, **huge black-pupiled eyes**
that dominate the face, a flat beakless face with only a small nostril
bump (no visible beak — this matches the text's "beakless" claim, which is
easy to doubt on a "bird" until you actually look), short furry-looking
...
gray** with almost no brown or warm tone, and its cheek patch is a small,
saturated **red-orange** blotch rather than the softer warm tan/orange seen
in every reference image — the real animal reads warmer and more
mottled/textured than the donor's flat two-tone fill. Second, the beak: the
donor sprite draws a small **visible dark beak/bill nub** at the front of
the face; canon porgs are explicitly and visibly **beakless** — a flat face
with only a tiny nostril crease, no protruding beak shape at all. Body
silhouette (round egg shape, big head, tiny legs, short wings) and the
...
- https://starwars.fandom.com/wiki/Porg (Wookieepedia article text, pulled
  ...
  2026-09-13)
- https://static.wikia.nocookie.net/starwars/images/e/ef/Porg-SWLS.png
  (infobox image, full front-on studio/puppet render, source: *Star Wars:
  Life Size*)
- https://static.wikia.nocookie.net/starwars/images/0/0d/Porg_nest.png
  (film still — a porg on its cliffside nest, *Star Wars: The Last Jedi*)
- https://static.wikia.nocookie.net/starwars/images/2/24/Hey_look_its_a_lightsaber.png
  (film still — two porgs investigating a discarded lightsaber on a cliff,
  *Star Wars: The Last Jedi*)

## Candidate images
- `wookieepedia_infobox.jpg` — Wookieepedia infobox render/puppet photo,
  full front-facing body, clearest single view of proportions, eyes, face,
  and plumage coloring
- `wookieepedia_nest.jpg` — film still, adult porg on its cliffside nest,
  side profile showing back/wing color pattern and coastal habitat
- `wookieepedia_shiny_lightsaber.jpg` — film still, two porgs on a grassy
  cliff investigating a dropped lightsaber, shows wings spread, habitat,
