...
**defName**: `Grank` (third-party, mlie.starwarsanimalcollection, not vendored — see Watch out)
...
- **Body plan**: a medium-sized predator/scavenger with sharp teeth and
  powerful crushing jaws. Classified under the wiki category **"Reptomammals"**
  (a Legends creature-type mixing reptilian and mammalian traits).
- **Senses**: hunted by feeling vibrations through body hair, both airborne
  and through the ground.
- **Diet/role**: the main predator of shiros, able to crack a shiro's shell
  with its jaws (shiros that partnered with tooke-trap plants could camouflage
  from it). Also occasionally hunted narglatch cubs, while fearing adult
  narglatches.
- **Relationship to Gungans/humans**: Gungans considered grank meat tasty and
  fried it; grank toenails were used to make Bongo submersible engine parts;
  the meat was sold as a delicacy in high-end restaurants. Imported
...
- **No coloration, height, length, mass, eye color, or skin/hair color is
  ...
  (`height`, `length`, `mass`, `skincolor`, `haircolor`, `eyecolor`) is blank.
  The text alone gives body plan and behavior only; color is entirely an
...
- https://starwars.fandom.com/api.php?action=parse&page=Grank&format=json&prop=wikitext
  ...
  2026-09-13)
- https://starwars.fandom.com/api.php?action=parse&page=Saw-toothed%20grank&format=json&prop=wikitext
  (full Legends article wikitext, pulled 2026-09-13)
- https://starwars.fandom.com/wiki/Saw-toothed_grank (article, for reference —
  not fetched directly; content pulled via the MediaWiki API above)
- https://static.wikia.nocookie.net/starwars/images/e/ef/Saw-toothed_grank.jpg
  (Wookieepedia infobox illustration)
- https://static.wikia.nocookie.net/starwars/images/e/e6/Saw-toothed_granks_on_Coruscant.jpg
  (Wookieepedia Coruscant-scene illustration)
- https://steamcommunity.com/sharedfiles/filedetails/?id=3497316713 (donor
  mod `mlie.starwarsanimalcollection`, current 1.6 Steam Workshop listing —
  source of the roster-grid screenshot below; legacy listing id
  `2903582351` was not separately checked since the current listing already
