...
```
M Transient/codebase_health.html            MACBENCH — generated; COMMITTED at 230c5737a after this skeleton was written
 M Transient/codebase_health.json            MACBENCH — generated; COMMITTED at 230c5737a
 M Transient/codebase_health_artifact.html   MACBENCH — generated; COMMITTED at 230c5737a
 M infrastructure/dashboards/hub/data/health.json   MACBENCH — generated; COMMITTED at 230c5737a
 M infrastructure/state/codebase_health_last.json  MACBENCH — generated; COMMITTED at 230c5737a
```
...
`prune`/`list`, and rimflow calls trip it — so they are generated, never hand-edited. They were
committed at `230c5737a` before this handoff was finished.
