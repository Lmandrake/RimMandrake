...
as-of: 2026-09-11T19:21:57Z (the last event's own timestamp, not the render clock)
...
## ART_REGEN_WAVE4_QUEUE_1 ART_REGEN_WAVE4_QUEUE_1
state:    doing
row:      unassigned
needs:    offline
target:   v1
kind:     build
summary:  (no items/ART_REGEN_WAVE4_QUEUE_1.md yet — write one when you have something to say)
prose:    infrastructure/state/items/ART_REGEN_WAVE4_QUEUE_1.md
