...
as-of: 2026-09-24T21:41:58Z (the last event's own timestamp, not the render clock)
game:  UP   bridge: free
...
target:   v1
kind:     task
summary:  Rule, with the owner at the bench, everything the sheet still owes so the
