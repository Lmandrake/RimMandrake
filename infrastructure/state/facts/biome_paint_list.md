...
- **PAINT: 27** — the 23 standalone `RUT_` regions not otherwise flagged (including
  ...
  `RM_FloodedCanyon` and `RM_GelatinousSlime`.
- **NO PAINT: 6** — `RUT_Jawa_BackgroundWater` and `RUT_LanternDeeps` (both never carry a
  ...
  `RUT_Greentide`, `RUT_CrackedLands` and `RUT_Slime`; and `RUT_Umbra` (restored 2026-09-21
...
- **UNDECIDED: 0** — both twin questions are ruled. Cracked Lands / Flooded Canyon on
...
- **Total rows: 33** owned BiomeDefs (27 + 6).
