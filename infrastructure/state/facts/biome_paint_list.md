...
| `RUT_TheRot` | the Rot | `UtinniPatches` / `mandrake.rut.patches` | yes | terrain + plants + fauna present (242 lines) | Nightspill, Frostcaps, Sporefields, Sootreach, Hanging Wood | 2204 | PAINT |
