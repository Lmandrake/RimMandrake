...
- **What it is**: the Assailant weapon in biological overdrive — ambient heat and energy
  drove it into frenzy, mutation and contagion. Pillage from Alpha Biomes/Alpha Animals:
  `AB_RedFog` weather (accuracy + mood), the alien/red flora suite, the contagion fauna
