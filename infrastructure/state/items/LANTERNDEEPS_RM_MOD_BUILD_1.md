...
injection layer, so it does steps 1, 2, 4, 5, 6 only. Its host test is TEMPERATURE, not a
biome list; that is what makes it RimMandrake-tier. `Patches/RUT_LanternDeepGateKotorStygium.xml`
