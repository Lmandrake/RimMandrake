...
- Design inputs already written (campaign register — generalize, don't copy
  ...
  weeks canon), `design/Jawa/flood_witness_event_draft.md` (phase-by-phase
  beat: chimes → water → growth → terminal moment),
  `design/Jawa/explosive_plant_growth_draft.md` (growth mechanic; terminal
...
- The CAMPAIGN plot beat (guaranteed first witnessing, routes/cards in
  `flood_witness_event_draft.md`) stays in the Utinni layer and consumes this
