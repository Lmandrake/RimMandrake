...
with RimBridge(host, port, token, timeout=25) as rb:
    for i in range(40):
        ...
        filth = [t["defName"] for t in cell["cell"]["things"]]
        print(i, s.get("advancedTicks"), "ticksGame=", s.get("endTicksGame"), "| job=", b.get("job"), "mentalState=", b.get("mentalState"), "| wall-cell:", filth)
