...
|---|---|---|---|
| A | ⛔ DEAD 2026-09-12 — **texture compression is ALREADY ON** (MEASURED, live `Prefs.xml`); this row ranked it the biggest lever at 5–10 GB and that figure is superseded. The real un-banked lever is the 1,578 non-%4 textures (~2.0 GB): `Transient/rimworld_memory_audit_2026-09-12.md` | — | — |
