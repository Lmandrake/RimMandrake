...
with rb() as b:
    r = b.call("rimworld/execute_debug_action", {"path": "Actions" + chr(92) + "Regenerate All Grids"})
    print("REGRID success:", r.get("success"))
    b.call("jawa/clear_ui", {})
    b.call("rimworld/jump_camera_to_cell", {"x": 100, "z": 32})
    b.call("rimworld/set_camera_zoom", {"rootSize": 12})
    time.sleep(2)
    s = b.call("jawa/take_screenshot", {"fileName": "rg_" + tag})
